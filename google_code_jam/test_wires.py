...
class Test(TestCase):
    ...
    def test_calculate_intersections_performances(self):
        # TODO : to be tested with 1000 + a timeout to test performances
        ...
        print(wires.calculate_intersections(list(zip(inputs, outputs))))
